...

{
 ...
 ;; contrib libraries
 :clojure-versions
 ["1.2.0" "1.2.1" "1.3.0" "1.4.0" "1.5.1" "1.6.0" "1.7.0" "1.8.0" "1.9.0-alpha14" "1.9.0-master-SNAPSHOT"]
 ...
 [{:name "algo.monads"        :owners ["konradhinsen"]}
  ...
  {:name "data.xml"           :owners ["ryansenior" "hhochleitner"] :min-clojure "1.4.0" :exclude-jdk #{"IBM JDK 1.6"}}
